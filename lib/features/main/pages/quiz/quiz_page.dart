...
import 'package:mobile/features/main/pages/quiz/quiz_post_page.dart';
...
class QuizPage extends StatefulWidget {
  ...
  const QuizPage({required this.topicId, required this.topicName, super.key});
...
class _QuizPageState extends State<QuizPage> {
  ...
  void initState() {
    ...
    Quiz.getQuiz(widget.topicId).then((_) {
      setState(() {
  ...
  double getScore() {
    double finalScore = 0;
    double scorePerQuestion = 100 / Quiz.listQuiz.length;

    for (int i = 0; i < Quiz.listQuiz.length; i++) {
      if (Quiz.listQuiz[i].correctAnswer == selectedAnswerIndex[i]) {
                    ...
                    child: Padding(
                      ...
                      child: ListView(
                        children: [
                          ...
                          AnswerCard(
                            text: Quiz
                                .listQuiz[currentPageQuiz - 1].listAnswer[0],
                            isSelected:
                          ...
                          AnswerCard(
                            text: Quiz
                                .listQuiz[currentPageQuiz - 1].listAnswer[1],
                            isSelected:
                                selectedAnswerIndex[currentPageQuiz - 1] == 1,
                            onPressed: (bool isSelected) {
                              setState(() {
                          ...
                          AnswerCard(
                            text: Quiz
                                .listQuiz[currentPageQuiz - 1].listAnswer[2],
                            isSelected:
                          ...
                          AnswerCard(
                            text: Quiz
                                .listQuiz[currentPageQuiz - 1].listAnswer[3],
                            isSelected:
